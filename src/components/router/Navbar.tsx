    ...
    <nav className={`relative flex items-center justify-between p-4 shadow-md ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <div className='flex justify-center items-center'>
        ...
        <label className="inline-flex items-center relative ml-4">
            ...
            />
            <div
            className="relative w-[110px] h-[50px] bg-white peer-checked:bg-gray-700 rounded-full after:absolute after:content-[''] after:w-[40px] after:h-[40px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-gray-600 peer-checked:after:to-gray-600 after:rounded-full after:top-[5px] after:left-[5px] active:after:w-[50px] peer-checked:after:left-[105px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"
            ></div>
            <svg
            height="0"
            width="100"
